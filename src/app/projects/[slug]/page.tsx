              ...
              <div className="max-w-4xl">
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    {project.featured && (
                      <span className="bg-gradient-to-r from-amber-400 to-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  ...
                  {project.area && (
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                      <Home className="w-6 h-6 text-orange-400 mb-2" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              ...
              <div className="space-y-8">
                  ...
                  <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                    ...
                    <div className="space-y-3">
                      {formatServices(project.services).map((service, index) => (
                        <div 
                          key={index}
                          className="flex items-center p-3 bg-orange-50 rounded-xl border border-orange-100"
                        >
                          <div className="w-2 h-2 bg-orange-500 rounded-full mr-3"></div>
                          <span className="text-orange-800 font-medium">{service}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-orange-600 to-amber-600 rounded-3xl p-8 text-white">
                  ...
                  <Link
                    href="/#contact"
                    className="inline-flex items-center bg-white text-orange-600 px-6 py-3 rounded-xl font-semibold hover:bg-orange-50 transition-colors"
                  >
                    Start Your Project
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {project.gallery.map((image, index) => (
                  <div 
                    key={index} 
                    className="relative rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group aspect-[4/3]"
                  >
                    <Image
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-orange-50 via-white to-amber-50">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/#contact"
                className="inline-flex items-center bg-orange-600 text-white px-8 py-4 rounded-2xl font-semibold hover:bg-orange-700 transition-colors shadow-lg hover:shadow-xl"
              >
                Start Your Project
